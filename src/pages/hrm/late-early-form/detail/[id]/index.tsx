...
const LateEarlyFormModal = ({ ...props }: Props) => {
    ...
    errors.name ? <div className="mt-1 text-danger">{errors.name}</div> : null
        ...
        />
                                            ...
                                            <div className="mb-5 w-1/2">
                                                ...
                                                <Field autoComplete="off" disabled id="fromdate" type="time" name="fromdate" className="form-input" placeholder={`${t('choose_register_from_date')}`} />
                                            ...
                                            <div className="mb-5 w-1/2">
                                                ...
                                                <Field autoComplete="off" disabled id="enddate" type="time" name="enddate" className="form-input" placeholder={`${t('choose_register_end_date')}`} />
    ...
    errors.checker ? <div className="mt-1 text-danger">{`${errors.checker}`}</div> : null
                                            ...
                                            <div className="mb-5 w-1/2">
                                                ...
                                                <Field autoComplete="off" disabled as="textarea" name="reason" id="reason"
