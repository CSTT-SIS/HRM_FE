                            ...
                            {t('back')}
									...
									<Formik
										initialValues={{
                                            ...
                                            position: props?.data ? `${props?.data?.position}` : null,
                                            department: props?.data ? `${props?.data?.department}` : null,
                                            submitday: props?.data ? `${props?.data?.submitday}` : null,
                                            fromdate: props?.data ? `${props?.data?.fromdate}` : null,
                                            enddate: props?.data ? `${props?.data?.enddate}` : null,
                                            shift: props?.data ? `${props?.data?.shift}` : null,
