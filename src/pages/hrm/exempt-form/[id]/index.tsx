...
const LateEarlyFormModal = ({ ...props }: Props) => {
									...
									>
										{({ errors, touched, submitCount, setFieldValue }) => (
                                            ...
                                            <div className="mb-5 w-1/2">
                                                ...
                                                <Field autoComplete="off" as="select" name="name" id="name" className="form-input">
    ...
    errors.name ? <div className="mt-1 text-danger">{errors.name}</div> : null
                                            ...
                                            <div className="mb-5 w-1/2">
                                                ...
                                                <Field autoComplete="off" as="select" name="position" id="position" className="form-input">
        ...
        />
                                            ...
                                            <div className="mb-5 w-1/2">
                                                ...
                                                <Field autoComplete="off" id="submitday" type="datetime-local" name="submitday" className="form-input" placeholder={`${t('choose_submit_day')}`} />
                                            ...
                                            <div className="mb-5 w-1/2">
                                                ...
                                                <Field autoComplete="off" id="fromdate" type="datetime-local" name="fromdate" className="form-input" placeholder={`${t('choose_from_day')}`} />
                                            ...
                                            <div className="mb-5 w-1/2">
                                                ...
                                                <Field autoComplete="off" id="enddate" type="datetime-local" name="enddate" className="form-input" placeholder={`${t('choose_end_day')}`} />
