...
import { OrderType } from '@/services/swr/statistic.twr';
...
const StocktakePage = ({ ...props }: Props) => {
    ...
    // get data
    const { data: orderType, pagination } = OrderType({ ...router.query });

    useEffect(() => {
        dispatch(setPageTitle(`${t('Order type')}`));
    });
