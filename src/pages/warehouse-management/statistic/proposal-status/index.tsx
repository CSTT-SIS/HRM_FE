...
import { ProposalStatus } from '@/services/swr/statistic.twr';
...
const StocktakePage = ({ ...props }: Props) => {
    ...
    // get data
    const { data: proposalStatus, pagination } = ProposalStatus({ ...router.query });

    useEffect(() => {
        dispatch(setPageTitle(`${t('Proposal status')}`));
    });
