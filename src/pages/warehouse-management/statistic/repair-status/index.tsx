...
import { RepairStatus } from '@/services/swr/statistic.twr';
...
const StocktakePage = ({ ...props }: Props) => {
    ...
    // get data
    const { data: repairStatus, pagination } = RepairStatus({ ...router.query });

    useEffect(() => {
        dispatch(setPageTitle(`${t('repair status')}`));
    });
